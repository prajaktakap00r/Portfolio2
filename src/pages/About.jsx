  ...
  return (
    <div className="m-2 p-2">
      <div className="text-white p-1">
        ...
        <section
          id="home"
          className="flex flex-col md:flex-row items-center justify-center h-auto md:h-[35rem]"
        >
          <img
            src={profileImage}
            alt="Proud self"
            className="rounded-md p-2 w-40 h-40 md:w-62 md:h-60 mb-4 border-white"
          />
          <div className="flex flex-col items-center md:items-start md:ml-10">
            <h1 className="text-3xl md:text-5xl font-bold text-purple-300 text-center md:text-left mb-4">
              Prajakta Kapoor
            </h1>
            <p className="text-md md:text-lg text-rose-50 text-center md:text-left mb-8">
        ...
        <section id="about" className="p-6">
          <h2 className="text-2xl md:text-4xl font-bold text-center mb-4 text-purple-300">
          ...
          <div className="mx-auto px-4 mt-10 border-2 bg-pink-300/20 rounded-md border-rose-300 shadow-lg hover:shadow-rose-300 w-full max-w-4xl overflow-hidden transform hover:scale-105 transition-transform duration-500 ease-in-out">
            <div className="text-white p-6">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <h1 className="text-lg md:text-xl font-bold uppercase text-rose-300">
                  Chandigarh University
                </h1>
                <h2 className="mt-2 md:mt-0 text-sm md:text-base">2021-2025</h2>
              </div>
          ...
          <div className="mx-auto px-4 mt-10 border-2 bg-pink-300/20 rounded-md w-full border-rose-300 shadow-lg hover:shadow-rose-300 max-w-4xl overflow-hidden transform hover:scale-105 transition-transform duration-500 ease-in-out">
            <div className="text-white p-6">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <h2 className="mt-2 md:mt-0 text-sm md:text-base">2020-2021</h2>
              </div>
              <hr className="my-4" />
          ...
          <div className="mx-auto px-4 mt-10 border-2 bg-pink-300/20 rounded-md border-rose-300 shadow-lg hover:shadow-rose-300 w-full max-w-4xl overflow-hidden transform hover:scale-105 transition-transform duration-500 ease-in-out">
            <div className="text-white p-6">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <h2 className="mt-2 md:mt-0 text-sm md:text-base">2018-2019</h2>
              </div>
              <hr className="my-4" />
              <h4>Matriculation</h4>
        ...
        <section
          id="achievements"
          className="p-6 md:p-36 justify-center align-middle"
        >
          <h2 className="text-2xl md:text-4xl font-bold text-center mb-4 text-purple-300">
            Achievements
          </h2>

          <div className="flex flex-col md:flex-row justify-between gap-10 w-full md:w-[70rem] h-auto md:h-[8rem]">
